...
public class Player : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (health == 5){
			GUI.DrawTexture(new Rect(0,0,512,80),health1);
		}
		if (health == 4){
			GUI.DrawTexture(new Rect(0,0,512,80),health2);
		}
		if (health == 3){
			GUI.DrawTexture(new Rect(0,0,512,80),health3);
		}
		if (health == 2){
			GUI.DrawTexture(new Rect(0,0,512,80),health4);
		}
		if (health == 1){
			GUI.DrawTexture(new Rect(0,0,512,80),health5);
		}
		if (health <= 0){
			GUI.DrawTexture(new Rect(0,0,512,80),health6);
		}
	}
}
